    ...
    return (
        <div>
            ...
            <div className="font-space w-full max-w-[780px] mx-auto flex flex-col gap-8 px-10 max-sm:px-5">
                ...
                <div>
                    <p className="rounded-lg hover:bg-base-200/75 duration-200 p-1 px-2 -ml-2 leading-loose w-fit">
                        sparktoapp.com website is owned by NILTweb, which is a
                        data controller of your personal data.
                    </p>
                    <p className="rounded-lg hover:bg-base-200/75 duration-200 p-1 px-2 -ml-2 leading-loose w-fit">
                        We have adopted this Privacy Policy, which determines
                        how we are processing the information collected by
                        sparktoapp.com, which also provides the reasons why we
                        must collect certain personal data about you. Therefore,
                        you must read this Privacy Policy before using
                        sparktoapp.com website.
                    </p>
                    <p className="rounded-lg hover:bg-base-200/75 duration-200 p-1 px-2 -ml-2 leading-loose w-fit">
                ...
                <div>
                    ...
                    <p className="rounded-lg hover:bg-base-200/75 duration-200 p-1 px-2 -ml-2 leading-loose w-fit">
                        When you visit the sparktoapp.com, we automatically
                ...
                <div>
                    ...
                    <p className="rounded-lg hover:bg-base-200/75 duration-200 p-1 px-2 -ml-2 leading-loose w-fit">
                        ...
                        contact@sparktoapp.com.
                    </p>
                </div>
                <div>
                    <h2 className="font-poppins font-bold">Your rights:</h2>
                    <p className="rounded-lg hover:bg-base-200/75 duration-200 p-1 px-2 -ml-2 leading-loose w-fit">
                        If you are a European resident, you have the following
                        rights related to your personal data:
                    </p>
                    <p className="rounded-lg hover:bg-base-200/75 duration-200 p-1 px-2 ml-5 w-fit">
                ...
                <div>
                    ...
                    <p className="rounded-lg hover:bg-base-200/75 duration-200 p-1 px-2 -ml-2 leading-loose w-fit">
                        ...
                        parties&apos; privacy practices. We encourage you to be
                        aware when you leave our website and read the privacy
